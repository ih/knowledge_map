...
****** CANCELED clear the form
it's probably useful to have the previous results in the form, especially for rapid adding of nodes
****** add the other parents as otherParents data
