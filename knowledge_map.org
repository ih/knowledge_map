...
******** DONE approaches
going with form inside context menu option
...
******** add html for the input in knowledgeMap.html
for now have it outside of the map, eventually have the forms appear in the node?
...
******** make the form hidden initially
******** jquery for visibility
have the action of the form option be a slidedown call for the form
use .show()
******* form submit action
have submission of the form add parents to appropriate node
